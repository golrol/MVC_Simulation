...
enum{DEAD, STOPPED, MOVING_TO_DESTINATION, MOVING_ON_COURSE, PEASANT_SPEED=5, PEASANT_HEALTH_MAX=20, PEASANT_HEALTH=10, KNIGHT_SPEED=10, THUG_SPEED_MAX=30, THUG_HEALTH=5, THUG_HEALTH_MAX=20, PEASANT=0, KNIGHT=1, THUG=2};
